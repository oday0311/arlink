...
public class WalletTest {
    ...
    static public Wallet wallet = new Wallet();
    ...
    public void TestReward(){
       ...
       String reward = wallet.updateReward(price, speedFactor);
       System.out.println("the update reward is "+ reward);

        {
            speedFactor = 12;
            reward = wallet.updateReward(price, speedFactor);
            System.out.println("the update reward is "+ reward);
